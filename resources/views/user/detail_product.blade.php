                    ...
                    <div class="p-l-25 p-r-30 p-lr-0-lg">
                        <div class="wrap-slick3 flex-sb flex-w">
                            ...
                            <div class="slick3 gallery-lb">
                                ...
                                <div class="item-slick3" data-thumb="template_admin/img/{{ $products->ProImage }}">
                                    <div class="wrap-pic-w pos-relative">
                                        <img src="template_admin/img/{{ $products->ProImage }}" alt="IMG-PRODUCT">

                                        <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
                                            href="template_admin/img/{{ $products->ProImage }}">
                ...
                <div class="col-md-6 col-lg-5 p-b-30">
                    <div class="p-r-50 p-t-5 p-lr-0-lg">
                        ...
                        <p class="stext-102 cl3 p-t-23">
                            Khuyến mãi
                            Giá và khuyến mãi dự kiến áp dụng đến 23:00 | 18/06
                            Thu cũ Đổi mới: Giảm đến 2 triệu (Tùy model máy cũ, không kèm các hình thức thanh toán
                            online, mua kèm) Xem chi tiết
        ...
        <div class="bor10 m-t-50 p-t-43 p-b-40">
            ...
            <div class="tab01">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item p-b-10">
                        <a class="nav-link" data-toggle="tab" href="#information" role="tab">Thông số sản
                            phẩm</a>
                    </li>
                                    ...
                                    <div class="col-md-3 col-xl-3 px-0">
                                        ...
                                        <div class="block1 wrap-pic-w " id="do-rong">
                                            <div class="block1-img">
                                                <img src="/template_admin/img/{{ $all->ProImage }}" alt="IMG-BANNER">
                                                <div class="block2-txt" id="txt">

                                                    <h3>{{ $all->ProName }}</h3><br>
                                                    <h4>{{ $all->ProPrice }}đ</h4>
                                                </div>
                                            </div>
